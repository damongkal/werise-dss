...
class ajax_oryza2 extends ajax_base
{
    ...
    protected function actionCombilist()
    {
        ...
        $this->addAccesslog($dataset, $crop1, $crop2);
        // recommended advisory or customized advisory
    ...
    private function addAccesslog(werise_core_dataset $dataset, $crop1, $crop2)
    {
        ...
        $sql2 = sprintf($sql, $userid, $dataset->getCountryCode(), $dataset->getStationId(), $dataset->getYear(), $dataset->getWType(), $db->escape($crop1['variety']), $db->escape($crop1['fert']));
        $db->query($sql2);
        $sql3 = sprintf($sql, $userid, $dataset->getCountryCode(), $dataset->getStationId(), $dataset->getYear(), $dataset->getWType(), $db->escape($crop2['variety']), $db->escape($crop2['fert']));
        $db->query($sql3);
    }
}
